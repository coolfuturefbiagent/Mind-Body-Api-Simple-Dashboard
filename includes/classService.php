...
{	
	...
	public function GetClassDescriptions(array $classDescriptionIDs, array $staffIDs, array $locationIDs, $startTime, $endTime, $PageSize = NULL, $CurrentPage = NULL, $XMLDetail = XMLDetail::Full, $Fields = NULL, SourceCredentials $credentials = null)
	{
		...
		if (isset($startTime))
		{
			$additions['StartClassDateTime'] = $startTime->format(DateTime::ATOM);
		}
		if (isset($endTime))
		{
			$additions['EndClassDateTime'] = $endTime->format(DateTime::ATOM);
		}
	...
	public function GetClassSchedulesRequest(array $sessiontypeids,$PageSize = NULL, $CurrentPage = NULL, $XMLDetail = XMLDetail::Full, $Fields = NULL, SourceCredentials $credentials = null){
